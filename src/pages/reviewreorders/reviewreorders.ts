...
import { Editcart2Page } from '../editcart2/editcart2';
import { CustselectPage } from '../custselect/custselect';

@IonicPage()
@Component({
  selector: 'page-reviewreorders',
  templateUrl: 'reviewreorders.html'
})
export class ReviewreordersPage {
    http: Http;
    mailgunUrl: string;
  ...
  public userId;
  po: AngularFireList<any> = this.db.list('/re-orders');
...
this.navCtrl.push(Editcart2Page, {
...
this.navCtrl.setRoot(ReviewreordersPage, {
    fourthPassed: this.prevAveragesList,
    emailS: this.emailS
   })
